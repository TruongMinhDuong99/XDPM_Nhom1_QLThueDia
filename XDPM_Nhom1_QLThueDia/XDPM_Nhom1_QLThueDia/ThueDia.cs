...
namespace XDPM_Nhom1_QLThueDia
{
    public partial class ThueDia : Form
    {
        ...
        private void tbxDiaChi_TextChanged(object sender, EventArgs e)
        {
        ...
        private void grpDia_Click(object sender, EventArgs e)
        {
        ...
        private void lblMaDia_Click(object sender, EventArgs e)
        {

        }

        private void grpThanhTien_Click(object sender, EventArgs e)
        {
        ...
        private void tbxNoConLai_TextChanged(object sender, EventArgs e)
        {
        ...
        private void tbxTongNo_TextChanged(object sender, EventArgs e)
        {
